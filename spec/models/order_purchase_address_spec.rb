    ...
    describe '商品の購入' do
      ...
      context '購入できないとき' do
        ...
        it 'postal_codeに"-"が含まれていないとでは購入できない' do
          ...
          @order_purchase_address.valid?
          expect(@order_purchase_address.errors.full_messages).to include("Postal code Please include a hyphen in the postal code. (e.g., 123-4567)")
        end
        ...
        it 'phone_numberが9桁以下だと購入できない' do
          ...
          @order_purchase_address.valid?
          expect(@order_purchase_address.errors.full_messages).to include("Phone number Please enter a valid phone number using only 10 or 11 digits without any hyphens.")
        end
